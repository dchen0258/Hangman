...
public class HangmanCanvas extends GCanvas {
	...
	public void reset() {
		removeAll();
		GLine scaffold = new GLine(50, 75, 50, 75 + SCAFFOLD_HEIGHT);
		GLine beam = new GLine(50, 75, 50 + BEAM_LENGTH, 75);
		GLine rope = new GLine(50 + BEAM_LENGTH, 75, 50 + BEAM_LENGTH, 75 + ROPE_LENGTH);
	}
